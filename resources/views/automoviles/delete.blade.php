        ...
        <div id="espaciolateral">
            <div id="lateral">
                ...
                <ul><!--Aquí coloquen los links hacia las otras vistas de sus entidades-->
                    ...
                    <li><a href="/automoviles/delete"  style="background-color: green;">Eliminar</a></li>
                </ul>
            </div>
            ...
            <div id="principal">
                ...
                <table id="automoviles" width="80%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>{{ $automovil->peso }}</td>
                        <td>{{ $automovil->capacidad_carga }}</td>
                        <td>{{ $automovil->fk_modelo }}</td>
                        <td>{{ $automovil->fk_sucursal }}</td>
                        <td><a href="/automoviles/{{ $automovil->codigo }}"/>Eliminar</td>
                    </tr>
                    @endforeach
                </table>
                </div>
