        ...
        <div id="espaciolateral">
            <div id="lateral">
                ...
                <ul><!--Aquí coloquen los links hacia las otras vistas de sus entidades-->
                    <li><a href="/barcos/create" style="background-color: green;">Crear</a></li>
                    <li><a href="/barcos">Consultar</a></li>
                    <li><a href="/barcos/update">Modificar</a></li>
        ...
        <div id="centro">
            <div id="principal">
             ...
             <!--   <div style="margin-left:16%; margin-top:30px">-->
                    <div id="formulario">
                        <form action="{{ action('BarcosController@store') }}" method="post">
                            {{ csrf_field() }}
                            <table>
                                <tr>
                                    <td>Peso:</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="num_pisos" />
                                    </td>
                                </tr>
                                <tr>
