...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="centro">
            <div id="principal">
                <h1>Editar el Barco: {{ $barco->codigo }}</h1>
             <!--   <div style="margin-left:16%; margin-top:30px">-->
                    <div id="formulario">
                        <form action="/barcos/update/{{$barco->codigo}}" method="post">
                            {{ csrf_field() }}
                            <table>
                                <tr>
                                    <td>Peso:</td>
                                    <td>
                                        <input type="text" name="peso" value="{{ $barco->peso }}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Capacidad de carga (kg):</td>
                                    <td>
                                        <input type="text" name="capacidad_carga" value="{{ $barco->capacidad_carga }}"/>
                                    </td>
                                </tr>
                                <td>Descripcion:</td>
                                    <td>
                                        <input type="text" name="descripcion" value="{{ $barco->descripcion }}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Clasificación:</td>
                                    <td>
                                        <input type="text" name="clasificacion" value="{{ $barco->clasificacion }}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Propulsión:</td>
                                    <td>
                                        <input type="text" name="propulsion" value="{{ $barco->propulsion }}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Número de pisos:</td>
                                    <td>
                                        <input type="text" name="num_pisos" value="{{ $barco->num_pisos }}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Velocidad máxima:</td>
                                    <td>
                                        <input type="text" name="velocidad_max" value="{{ $barco->velocidad_max }}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Sucursal:</td>
