                        ...
                        <form action="{{ action('EmpleadosController@store') }}" method="post">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="correo_pers" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>Correo de la empresa:</td>
                                    <td>
                                        <input type="text" name="correo_emp" />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="num_hijos" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>Fecha de Ingreso a la compañía:</td>
                                    <td>
                                        <input type="date" name="fecha_ingr">
                                    </td>
                                </tr>
                                <!--<tr>
                                    <td>Fecha de egreso:</td>
                                    <td>
                                        <input type="date" name="fecha_egre">
                                    </td>
                                </tr>-->
                                <tr>
                                    <td>Dirección:</td>
