...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="centro">
            <div id="principal">
                <h1>Detalle del horario de las inasistencias de los empleados</h1>
                        ...
                        <table id="empleados" width="80%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$empleado->asistio}}</td>
                                    <td>{{$empleado->fecha_trabajada}}</td>
                                    <td>{{$empleado->dia}}</td>
                                    <td>{{$empleado->hora_ent}}</td>
                                    <td>{{$empleado->hora_sal}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
